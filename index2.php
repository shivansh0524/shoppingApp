...
<div class="media-element">
       <h5 id="header" style="font-weight:bolder; font-size:7em; padding:1.50em 0 0 3rem;  color:rgb(34, 84, 270);">Name Here</h5>
       <p style="color:rgba(88, 88, 88, 0.900); font-weight:bold; font-size:1rem; padding:1em 0 0 6em; height:21vh;line-height: 1.6;">An online grocery shop aims at delivering the best quality grocery items directly to customer's doorstep at competitive prices. Users in this case have the ability to order products from the company's website and choose a time slot for the delivery.</p>
