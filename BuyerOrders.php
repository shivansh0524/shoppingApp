  ...
  <div class="container h-100 py-5"style="width:100%">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-10">
        ...
        $email=$_SESSION['buyer'];
        $orderIds = array();
        $sql = "SELECT DISTINCT Order_Id FROM orders WHERE Email='$email'";
        $result =mysqli_query($conn,$sql);
        if(mysqli_num_rows($result)>0){
        ...
        <div class="col-md-2 ">
            <a href="OpenOrderProduct.php?id=<?php echo $orderId?>" style="text-decoration:none"> <div class="Button Button-one " style="width:4rem;margin:0 4rem 1rem 0;">View</div>
           </a> 
           <a href="invoice.php?id=<?php echo $orderId?>" style="text-decoration:none"> <div class="Button Button-one" style="width:4rem;margin:0 4rem 1rem 0;">Invoice</div>
           </a>  </div>
