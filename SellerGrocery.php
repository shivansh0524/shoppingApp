...
<div class="row">
    ...
    <input type="text" class="form-control" style="border-radius: 20px;" name="spn" id="spn" placeholder="Enter Product name" autocomplete="off" required>
  ...
  <div class="form-group mt-5 mr-2 mb-5" >
    ...
    <input type="text" class="form-control" style="border-radius: 20px;" name="spt" id="spt" value="<?php echo $n; ?>" readonly>
  </div>
  <div class="form-group mb-3 mt-3 ">
    <label for="sdt" style="color:rgb(6, 94, 145);margin:0 0 0.5rem 0;font-size: 15px;" ><b>Diet Type:</b></label><br>
   <label style=" cursor:pointer;  padding:2px"> <input type="radio" name="sdt" value="veg" style="padding:10rem; background-color: #2196F3;"required> Veg</label><br>
   <label style=" cursor:pointer;  padding:2px"><input type="radio" name="sdt" value="nonveg" style="padding:1rem;"required> Non-veg</label><br>
  <br>
  ...
  <div class="form-group mt-1 mr-2" >
    ...
    <input type="text" class="form-control" style="border-radius: 20px;" name="spw" id="spw" placeholder="Enter Product Weight" required><div id="spw_error" style="color:red;display:none">*This field shouldn't contain apostrophe (' and "")</div>
...
if(isset($_POST['btn'])){
  ...
  $spni=$_POST['spni'];
    ...
    $sql="INSERT INTO stock(Email,Product,Diet_Type,Type,Weight,price,Available,Date,Brand,no_item) VALUES ('$email','$spn','$spdt','$spt','$spw',$spp,$spa,'$date1','$spb','$spni')";
