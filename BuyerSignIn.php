...
<form method="POST" action="BuyerSignin.php">
<div class="row">
  ...
  <div class="form-group mt-3">
    ...
    <input type="password" style="border-radius: 20px;" class="form-control" id="bp" name="bp" placeholder="Password" >
...
if(isset($_POST['btn'])){
  ...
  elseif($_POST['bp']==''){
    $be=$_POST['be'];
    header("Location:forgetPassBuyer.php?email=$be");
    } 
    else{ 
$be=$_POST['be'];
$bp=$_POST['bp'];
$sql="SELECT * FROM buyerdetails WHERE Email='$be' AND Password='$bp'AND Allow='allowed' ";
$sql1="SELECT * FROM buyerdetails WHERE Email='$be' AND Allow='allowed'";

$sql2="SELECT * FROM buyerdetails WHERE Email='$be' AND Password='$bp' AND Allow='restricted'";
