...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2023 at 05:48 PM
...
(1685, '96', 'anisha.bose@gmail.com'),
(1686, '33', 'anisha.bose@gmail.com'),
(1687, '33', 'anisha.bose@gmail.com');
...
(308, 'Ankita Dey', 'ankita.raima@gmail.com', '9434800080', 'Kalnaroad Pirpukur Burdwan,713101,House no-63 , Purba Bardhaman, West Bengal', 43, 'anapurna.bhandar@gmail.com', 'Tata Sampann Unpolished Moong Dal Chilka', 'Tata Sampann', '1', '500g', '18/06/23', '17/06/23', 134, 'Delivered', '12/08/23', '120230617083351'),
...
(310, 'Sanjib Kumar Dey', 'dey.sk66@gmail.com', '9474060606', 'Kalnaroad Pirpukur Burdwan,713101,House no-63 , Purba Bardhaman, West Bengal', 65, 'kesari.puja@gmail.com', 'Nestle Munch Chocolate Coated Crunchy Wafer Share Pack', 'Nestle', '1', '160.2 g|18 Units - 8.9 g each', '22/06/23', '17/06/23', 73, 'Delivered', '11/08/23', '620230617063424'),
...
(8, 'Seller', 'anapurna.bhandar@gmail.com', 'anisha.bose@gmail.com', 'Buyer'),
(9, 'Seller', 'mondira.mondal@gmail.com', 'anisha.bose@gmail.com', 'Buyer');
...
(36, 'Alok Gupta', 'male', 'anapurna.bhandar@gmail.com', 'Alok101', 'alok', '9156322901', 'Anapurna Bhander', 'Grocery', '6VQH+4GG,Desbandhu Nagar,Kalibazar,Natanpally,West Bengal 713101', 'west bengal', 'anapurna.bhandar@gmail.com.jpg', 'allowed', '', 'What is your bestfriend name ?', 'alok'),
(39, 'Puja Ghosh', 'female', 'kesari.puja@gmail.com', 'puja66', 'puja', '9647125911', 'Kesari', 'Confectionery', 'Kalnaroad pirpukur,Purba Bardhaman,713101', 'West Bengal', 'kesari.puja@gmail.com.jpg', 'allowed', '', 'What is your bestfriend name ?', 'raima'),
...
(39, 'anapurna.bhandar@gmail.com', 'Dabur Gluco Plus C Lemon', 'DABUR', 'veg', 'Grocery', '400gm', 1, 146, 8, '3920230813083444.jpg', '2023-04-18'),
...
(51, 'anapurna.bhandar@gmail.com', 'Kelloggs Corn Flakes Original | Power of 5: Energy, Protein, Iron, Calcium, Vitamins B1, B2, B3 & C| Corn Flakes, Breakfast Cereal | Naturally Cholestrol Free', 'Kelloggs ', 'veg', 'Grocery', '875g/900g(Weight may vary)', 1, 310, 10, '5120230422065847.jpg', '2023-04-18'),
...
(96, 'kishor.pal@gmail.com', 'Fortune Chakki Fresh Atta, 10 kg', 'Fortune', 'veg', 'Grocery', '10kg', 1, 441, 19, '9620230623063212.jpg', '2023-06-23'),
...
--
ALTER TABLE `addtocart`
  MODIFY `Serial_no` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1688;
...
--
ALTER TABLE `feedback`
  MODIFY `Serial_no` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `reports`
  MODIFY `Serial_no` int(245) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `wishlist`
  MODIFY `Serial_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1438;
COMMIT;
