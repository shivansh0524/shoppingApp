...
<div class="float-right icon">
  ...
  <a href="AdminUserDetails.php" style="display:flex;"><img src="<?php echo $photo ?>" style="height:9vh; width:9vh; object-fit: cover;  border-radius: 50px; margin-left:16rem; cursor:pointer"></a></div>
      ...
      <td>
        <div class="d-flex align-items-center">
          <img
              ...
              />
          <div class="ms-3">
          <a  href="BuyerView.php?id=<?php echo $Serial_no?>" style="text-decoration:none; color:black"><p class="fw-bold link2 mb-1"><?php echo $Name?></p></a>
