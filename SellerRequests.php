...
?>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-4">
      ...
      <li>
      <a class="nav-link" href="SellerRequests.php" >Requests</a>
...
<table class="table align-middle mb-0 bg-white" style=" position:relative;top:5rem;">
  ...
  <tbody>
<?php 
$sql="SELECT * FROM sellerdetails WHERE Allow=''";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)>0){
    while($row=mysqli_fetch_assoc($result)){
      ...
      <td>
        <div class="d-flex align-items-center">
          <img
              ...
              />
          <div class="ms-3">
          <a  href="SellerView.php?id=<?php echo $Serial_no?>" style="text-decoration:none;"><p class="fw-bold link2 mb-1"><?php echo $Name?></p></a>
